...
public class MovingCircle extends MovingObject {
	...
	public void playMovingObject_Top_Bottom(MovingObject movingObject, int paneWidth, int paneHeight){
		...
		topBottomObject_pt.setDuration(Duration.millis(6667)); /*.seconds(5));*/   // It takes a rectangle 5 seconds to pass along the full length of the screen
		...
		topBottomObject_pt.setCycleCount(3);   // cycle 4 times  (4  x 5 seconds = 20 seconds, time parameter for assignment)
	...
	public void playMovingObject_Bottom_Top(MovingObject movingObject, int paneWidth, int paneHeight) {
		...
		bottomTopObject_pt.setDuration(Duration.millis(6667)); /*.seconds(5));*/   // It takes a rectangle 5 seconds to pass along the full length of the screen
		...
		bottomTopObject_pt.setCycleCount(3);   // cycle 4 times  (4  x 5 seconds = 20 seconds, time parameter for assignment)
