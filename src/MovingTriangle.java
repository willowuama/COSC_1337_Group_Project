...
public class MovingTriangle extends MovingObject {
	...
	public void playMovingObject_Bottom_Top(MovingObject movingObject, int paneWidth, int paneHeight) {
		...
		bottomTopObject_pt.setDuration(Duration.seconds(5)); /*.seconds(2));*/   // It takes a rectangle 5 seconds to pass along the full length of the screen
	...
	public void playMovingObject_Right_Left(MovingObject movingObject, int paneWidth, int paneHeight) {
		...
		rightLeftObject_pt.setDuration(Duration.seconds(5)); /*.millis(6667));*/   // The star will pass through the screen in 6.667 seconds.
		...
		rightLeftObject_pt.setCycleCount(4);   // cycle 3 times to equal 20 seconds for the game
	...
	public void playMovingObject_Left_Right(MovingObject movingObject, int paneWidth, int paneHeight) {
		...
		leftRightObject_pt.setDuration(Duration.seconds(5)); /*.millis(2857));*/   // The star will pass through the screen in 2.857 seconds.
		...
		leftRightObject_pt.setCycleCount(4);   // cycle 7 times to equal 20 seconds for the game
